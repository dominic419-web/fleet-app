...
/**
 * Proxies the expense receipt Edge Function so the browser calls same-origin `/api/...`
...
export async function POST(request) {
  ...
  const upstreamUrlObj = new URL(`${origin}/functions/v1/process-expense-receipt`);
